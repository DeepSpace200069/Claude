...
const messages: Messages = {
  ...
  admin: {
    ...
    statUsers: 'Users',
    statEvents: 'Events',
    statPublished: 'Published invitations',
    statPaidOrders: 'Paid orders',
    statPendingOrders: 'Pending orders',
    statRevenue: 'Revenue',
    statPendingEntries: 'Messages awaiting review',

    usersSearch: 'Search by name or email',
    usersSearchAction: 'Search',
    usersEmpty: 'No users match this search.',
    usersEvents: 'Events: {count}',
    usersRole: 'Role',
    roleUser: 'User',
    ...
    ordersAll: 'All',
    ordersEmpty: 'No orders match this filter.',
    ordersActivate: 'Activate manually',
    ordersActivateTitle: 'Manual order activation',
    ordersActivateText:
      'The order will be marked as paid without a provider payment. The reason is recorded permanently in the audit log.',
    ordersReasonLabel: 'Reason',
    ordersReasonHint: 'For example: payment received by bank transfer, agreed free activation.',
    ordersActivated: 'Order activated.',
    ordersNoEvent: 'No event',

    plansTitle: 'Plans and limits',
    plansHint:
      'Values are read from the database — editing here changes what users can do immediately, with no redeploy.',
    plansName: 'Name',
    plansDescription: 'Description',
    plansPrice: 'Price (in minor units)',
    plansActive: 'Plan is offered',
    plansFlags: 'Features',
    plansLimits: 'Limits',
    plansLimitHint: 'An empty field means no limit.',
    plansSaved: 'Plan saved.',

    limits: {
      maxEvents: 'Maximum events',
      maxPhotos: 'Maximum photos',
      maxGuests: 'Maximum guests',
      maxSections: 'Maximum sections',
      maxCustomQuestions: 'Maximum extra questions',
      maxCollaborators: 'Maximum collaborators',
      maxSeatingVersions: 'Maximum seating versions',
    },
    ...
    promoKindFixed: 'Fixed amount',
    promoKindFree: 'Full discount',
    promoValue: 'Value',
    promoMax: 'Maximum redemptions',
    promoValidUntil: 'Valid until',
    promoUsed: 'Redeemed: {used}',
    promoCreate: 'Create code',
    promoCreated: 'Code created.',
    promoEmpty: 'No promo codes yet.',
    promoActivate: 'Enable',
    promoDeactivate: 'Disable',
    ...
    templatesHint:
      'Publishing a new version does not change existing invitations — they keep their own snapshot of sections. Only what new invitations start from changes.',
    templatesArchive: 'Archive',
    templatesRestore: 'Back to draft',
    templatesPublish: 'Publish template',
    templatesStatusChanged: 'Template status changed.',

    eventTypesTitle: 'Event types',
    eventTypesTemplates: 'Templates: {count}',
    eventTypesEnable: 'Enable',
    eventTypesDisable: 'Disable',
    eventTypesChanged: 'Event type updated.',
    eventTypesHint:
      'A disabled type is no longer offered for new events; existing events keep working.',

    auditTitle: 'Audit log',
    auditHint: 'Entries are never edited or deleted.',
