...
const SR_LATN: { rsvp: RsvpLabels; guestbook: GuestbookLabels } = {
  rsvp: {
    ...
    deadline: (date) => `Molimo vas da odgovorite do ${date}.`,
    ...
    maxGuests: (count) => `Ovaj link važi za najviše ${count} osoba.`,
  ...
  guestbook: {
    ...
    charactersLeft: (count) => `Preostalo znakova: ${count}`,
...
const SR_CYRL: { rsvp: RsvpLabels; guestbook: GuestbookLabels } = {
  rsvp: {
    ...
    deadline: (date) => `Молимо вас да одговорите до ${date}.`,
    ...
    maxGuests: (count) => `Овај линк важи за највише ${count} особа.`,
  ...
  guestbook: {
    ...
    charactersLeft: (count) => `Преостало знакова: ${count}`,
...
const EN: { rsvp: RsvpLabels; guestbook: GuestbookLabels } = {
  rsvp: {
    ...
    maxGuests: (count) => `This link is valid for up to ${count} people.`,
  ...
  guestbook: {
    ...
    charactersLeft: (count) => `Characters left: ${count}`,
...
const DE: { rsvp: RsvpLabels; guestbook: GuestbookLabels } = {
  rsvp: {
    ...
    deadline: (date) => `Bitte antworten Sie bis ${date}.`,
    ...
    maxGuests: (count) => `Dieser Link gilt für höchstens ${count} Personen.`,
  ...
  guestbook: {
    ...
    charactersLeft: (count) => `Verbleibende Zeichen: ${count}`,
